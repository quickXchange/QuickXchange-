...
const [ethereumMigrationSql, ethereumRangeMigrationSql, bscRpcMigrationSql, bscRangeMigrationSql, bscStablecoinIdentitySql, tronMigrationSql] =
  await Promise.all([
...
const exactTronConfigurationQuery = `
  SELECT 1
  FROM blockchain_monitor_networks monitor
