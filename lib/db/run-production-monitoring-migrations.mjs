...
const [ethereumMigrationSql, ethereumRangeMigrationSql, bscRpcMigrationSql, bscRangeMigrationSql, bscStablecoinIdentitySql, tronMigrationSql, tronEndpointMigrationSql] =
  await Promise.all([
