...
export const websiteBrandingSettingsTable = pgTable("website_branding_settings", {
  ...
  desktopLogoWidth: integer("desktop_logo_width").notNull().default(138),
  desktopLogoMaxHeight: integer("desktop_logo_max_height").notNull().default(30),
  tabletLogoWidth: integer("tablet_logo_width").notNull().default(130),
  tabletLogoMaxHeight: integer("tablet_logo_max_height").notNull().default(28),
  mobileLogoWidth: integer("mobile_logo_width").notNull().default(116),
  mobileLogoMaxHeight: integer("mobile_logo_max_height").notNull().default(28),
  ...
  check("website_branding_desktop_logo_width_check", sql`${table.desktopLogoWidth} between 40 and 320`),
  check("website_branding_desktop_logo_max_height_check", sql`${table.desktopLogoMaxHeight} between 16 and 44`),
  check("website_branding_tablet_logo_width_check", sql`${table.tabletLogoWidth} between 40 and 280`),
  check("website_branding_tablet_logo_max_height_check", sql`${table.tabletLogoMaxHeight} between 16 and 44`),
  check("website_branding_mobile_logo_width_check", sql`${table.mobileLogoWidth} between 32 and 220`),
  check("website_branding_mobile_logo_max_height_check", sql`${table.mobileLogoMaxHeight} between 16 and 44`),
