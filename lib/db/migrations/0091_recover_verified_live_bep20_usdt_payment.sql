...
BEGIN
  ...
  INSERT INTO blockchain_monitor_watches (
    ...
    'O180006775', v_network_id, v_asset_id, 'usdt-bep20',
  ...
  SELECT id INTO v_watch_id FROM blockchain_monitor_watches
  ...
  INSERT INTO blockchain_monitor_observations (
    ...
    '0x5e146076f9a16ddb8b76681536b9e021cde019def7fede9be0cb84687b9ac365:255:' || v_asset_id,
  ...
  SELECT id INTO v_observation_id FROM blockchain_monitor_observations
  WHERE monitor_network_id = v_network_id
    AND monitor_asset_id = v_asset_id
    AND transaction_hash = '0x5e146076f9a16ddb8b76681536b9e021cde019def7fede9be0cb84687b9ac365'
    AND event_index = '0x5e146076f9a16ddb8b76681536b9e021cde019def7fede9be0cb84687b9ac365:255:' || v_asset_id
  ...
  INSERT INTO blockchain_monitor_matches (
    ...
    v_watch_id, v_observation_id, 'O180006775', 'confirming',
    jsonb_build_object(
      'asset', 'usdt-bep20',
