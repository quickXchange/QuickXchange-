...
const POLICY_MATCHERS: readonly PolicyMatcher[] = [
  ...
  { method: "GET", pattern: /^\/admin\/providers\/whitebit\/verification-routes$/, policy: P("integrations.view", true) },
  ...
  { method: "POST", pattern: /^\/admin\/providers\/whitebit\/address-permission\/verify$/, policy: P("integrations.credentials.test", true) },
